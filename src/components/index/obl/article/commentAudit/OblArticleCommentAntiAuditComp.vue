        ...
        >
            <div>
                <a-form
                    ...
                    :form="createForm"
                >
                    <a-form-item :label="$t('langMap.table.fields.obl.articleCommentAuditRecord.antiAuditComments')"
...
<script>
    ...
    import {OblArticleCommentAntiAuditCompApi} from './OblArticleCommentAntiAuditCompApi'
    import {FormBaseConfObj} from "~Components/constant_define";
    import AFormItem from "ant-design-vue/es/form/FormItem";
    import ATextarea from "ant-design-vue/es/input/TextArea";

    export default {
        name: "OblArticleCommentAntiAuditComp",
        ...
        methods:{
            ...
            handleSubmit(){
                this.createForm.validateFields((err, values) => {
                    ...
                    OblArticleCommentAntiAuditCompApi.batchAntiAudit(values,this.commentIdList).then((res) => {
                        if(res.success){
