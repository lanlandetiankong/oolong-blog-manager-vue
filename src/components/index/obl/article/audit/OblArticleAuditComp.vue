        ...
        >
            <div>
                <a-form
                    ...
                    :form="createForm"
                >
                    <a-form-item :label="$t('langMap.table.fields.obl.articleAuditRecord.auditState')"
                    ...
                    <a-form-item :label="$t('langMap.table.fields.obl.articleAuditRecord.auditComments')"
                                 v-bind="FormBaseConfObj.formItemLayout"
                    >
...
<script>
    ...
    import {ArticleAuditStateEnum,EnumUtils} from '~Config/selectData.js';
    import {OblArticleAuditCompApi} from './oblArticleAuditCompApi'
    ...
    export default {
        ...
        data(){
            ...
            //允许选择的[审批值]
            let auditStateArr = [ArticleAuditStateEnum.ReturnToModify,ArticleAuditStateEnum.ApprovalFailed,ArticleAuditStateEnum.Approved] ;
            return {
                FormBaseConfObj,
                binding:{
        ...
        methods:{
            ...
            handleSubmit(){
                this.createForm.validateFields((err, values) => {
                    ...
                    OblArticleAuditCompApi.batchAudit(values,this.articleIdList).then((res) => {
                        if(res.success){
