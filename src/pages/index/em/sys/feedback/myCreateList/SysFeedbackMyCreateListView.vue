                ...
                >
                    ...
                    <obl-table-action slot="action" slot-scope="text,record">
                        <template slot="operates">
                            <table-operate-btn v-show="isShowHiddenOperate"
                                               :content="$t('langMap.button.actions.operate')"
                                               icon="control"
...
<script>
    import {SysFeedbackMyCreateListApi} from './SysFeedbackMyCreateListApi.js'
    ...
    export default {
        ...
        methods: {
            ...
            dealGetAllTypeTree() {    //取得所有的 类型-树
                var _this = this;
                SysFeedbackMyCreateListApi.queryTypeTree().then((res) => {
                    if (res.success) {
            ...
            dealBatchDeleteByIds() {  //批量删除
                ...
                SysFeedbackMyCreateListApi.batchDeleteByIds(delIds).then((res) => {
            ...
            dealDelOneRowById(delId) {   //根据id 删除
                var _this = this;
                SysFeedbackMyCreateListApi.deleteById(delId).then((res) => {
                    if (res.success) {  //已经有对错误进行预处理
                        _this.$message.success(res.msg);
                        _this.mixin_invokeQuery(_this); //表格重新搜索
                    }
            ...
            handleSearchFormQuery(e, values) {   //带查询条件 检索【系统反馈】列表
                ...
                SysFeedbackMyCreateListApi.querySelfDtoPage(values, _this.tableConf).then((res) => {
