...
export const SysFeedbackMyDraftListApi = {
    querySelfDraftDtoPage(queryArr, tableConf) {
        let obj = HttpUtil.formatQueryPage(queryArr,tableConf);
        //分页查询
        return axios.post('/oblCtl/emSysFeedback/querySelfDraftDtoPage', obj).then(res => res.data);
    },
