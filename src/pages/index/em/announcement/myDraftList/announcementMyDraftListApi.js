...
export const AnnouncementMyDraftListApi = {
    ...
    getPageQuery(queryArr,pagination,sorter) {   //取得 所有公告
        ...
        //查询所有公告信息
        return axios.post('/oblCtl/announcementDraft/queryDtoPage',qs.stringify(obj)).then(res => res.data);
    },
    batchDeleteByIds(ids) {  //批量删除
        var obj = {
            delIds:ids
        }
        return axios.post("/oblCtl/announcementDraft/batchDeleteByIds",qs.stringify(obj,{indices: false})).then(res => res.data) ;
    },
    deleteById(delId) {  //删除
        var obj = {
            delId:delId
