...
export const OblUserAccountApi = {
    getPageQuery(queryArr, pagination, sorter) {
        ...
        //查询所有用户信息
        return axios.post('/oblCtl/user/userAccount/queryDtoPage', qs.stringify(obj)).then(res => res.data);
    },
    ...
    batchDeleteByIds(ids) {  //批量删除
        ...
        return axios.post("/oblCtl/user/userAccount/batchDeleteByIds", qs.stringify(obj, {indices: false})).then(res => res.data);
    },
    deleteById(delId) {  //删除
        var obj = {
            delId: delId
        }
        return axios.post("/oblCtl/user/userAccount/deleteById", qs.stringify(obj, {indices: false})).then(res => res.data);
    },
