    ...
    export default {
        ...
        methods: {
            ...
            dealGetAllTagList(){    //取得所有的 文章标签
                var _this = this ;
                ArticleMyDraftListApi.getAllArticleTagEnums().then((res) =>{
                    if(res.success){
            ...
            dealGetAllCategoryTree() {    //取得所有的 文章分类
                var _this = this;
                ArticleMyDraftListApi.getAllArticleCategoryTree().then((res) => {
                    if (res.success) {
            ...
            dealBatchDel() {  //批量删除
                ...
                ArticleMyDraftListApi.batchDeleteByIds(delIds).then((res) => {
            ...
            dealDelOneRowById(delId) {   //根据id 删除
                var _this = this;
                ArticleMyDraftListApi.deleteById(delId).then((res) => {
                    if (res.success) {  //已经有对错误进行预处理
                        _this.$message.success(res.msg);
                        _this.mixin_invokeQuery(_this); //表格重新搜索
                    }
            ...
            handleSearchFormQuery(e,values) {    //带查询条件 检索文章列表
                ...
                ArticleMyDraftListApi.getPageQuery(values,_this.tableConf).then((res) => {
