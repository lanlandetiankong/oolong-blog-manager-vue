...
export const OblArticleCategoryApi = {
    ...
    getPageQuery(queryArr,pagination,sorter) {
        ...
        return axios.post('/oblCtl/oblArticleCategory/queryDtoPage',qs.stringify(obj)).then(res => res.data);
    },
    ...
    batchDeleteByIds(ids) {  //批量删除
        ...
        return axios.post("/oblCtl/oblArticleCategory/batchDeleteByIds",qs.stringify(obj,{indices: false})).then(res => res.data) ;
    },
    deleteById(delId) {  //删除
        var obj = {
            delId:delId
        }
        return axios.post("/oblCtl/oblArticleCategory/deleteById",qs.stringify(obj,{indices: false})).then(res => res.data) ;
    }
}
