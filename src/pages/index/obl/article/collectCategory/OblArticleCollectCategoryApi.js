...
export const OblArticleCollectCategoryApi = {
    ...
    getPageQuery(queryArr,tableConf) {
        ...
        return axios.post('/oblCtl/oblArticleCollectCategory/queryPage',obj).then(res => res.data);
    },
    getItemById(fid){  //根据id查询item
        var params = {
            fid:fid
        }
        return axios.post("/oblCtl/oblArticleCollectCategory/queryOneById",qs.stringify(params)).then(res => res.data) ;
    },
    ...
    batchDeleteByIds(ids) {  //批量删除
        ...
        return axios.post("/oblCtl/oblArticleCollectCategory/batchDeleteByIds",qs.stringify(obj,{indices: false})).then(res => res.data) ;
    },
    deleteById(delId) {  //删除
        var obj = {
            delId:delId
        };
        return axios.post("/oblCtl/oblArticleCollectCategory/deleteById",obj).then(res => res.data) ;
    }
}
